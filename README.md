...
1. [About](#about-wellbeing)
2. [Installation](#installation)
3. [FAQ](#why-hasnt-been-the-website-hosted)
...
1. `git clone https://github.com/ahmishra/Wellbeing.git`.
2. Switch to the directory in which the repository was cloned it.
3. Install the dependencies / requirements using `pip install -r requirements.txt`.
4. Run the server using `python main.py` or `python3 main.py`

## Why hasn't been the website hosted?
